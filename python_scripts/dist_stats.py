...
class Distance(wx.Panel):
    ...
    def __init__(self, parent, node_list):
        ...
        title = wx.StaticText(self, label="Distance")
        ...
        setattr(self, f"dist_row{self.count}", DistRow(self))
        self.main_sizer.Add(getattr(self, f"dist_row{self.count}"), 0, wx.ALL | wx.ALIGN_LEFT, 5)
        self.SetSizer(self.main_sizer)
        self.Layout()


class DistRow(wx.Panel):
    ...
    def on_add(self, event):
        ...
        setattr(self.parent, f"dist_row{self.parent.count}", DistRow(self.parent))
        self.parent.main_sizer.Add(getattr(self.parent, f"dist_row{self.parent.count}"), 0, wx.ALL | wx.ALIGN_LEFT, 5)
